 ...
 * @author Shai Almog
 */
public class WorldCupMainStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "WorldCupMain";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new WorldCupMainStub());
    }
